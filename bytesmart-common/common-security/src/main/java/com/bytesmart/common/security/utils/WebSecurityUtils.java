package com.bytesmart.common.security.utils;
...
public class WebSecurityUtils
{
     ...
     * 获取登录用户信息
     */
    public static LoginEmployee getLoginEmployee()
    {
        return SecurityContextHolder.get(SecurityConstants.LOGIN_USER, LoginEmployee.class);
    }
    ...
    {
        return employeeId != null && 1L == employeeId;
    }
