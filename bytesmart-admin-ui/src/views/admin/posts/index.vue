  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="岗位类型" prop="postType">
          <el-input v-model="form.postType" placeholder="请输入岗位类型00全职 01兼职" />
        </el-form-item>
        <el-form-item label="岗位权重" prop="postWeight">
...
<script>
import { listPosts, getPosts, delPosts, addPosts, updatePosts } from "@/api/admin/posts";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        postWeight: [
          { required: true, message: "岗位权重不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('admin/posts/export', {
        ...this.queryParams
