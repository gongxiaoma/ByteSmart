<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="岗位权重" prop="postWeight">
        <el-input
          v-model="queryParams.postWeight"
          placeholder="请输入岗位权重"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['webadmin:post:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['webadmin:post:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="岗位类型" prop="postType">
          <el-input v-model="form.postType" placeholder="请输入编码名称" />
        </el-form-item>
        <el-form-item label="岗位权重" prop="postWeight">
          <el-input-number v-model="form.postWeight" controls-position="right" :min="0" />
        </el-form-item>
...
<script>
import { listPost, getPost, delPost, addPost, updatePost } from "@/api/webadmin/post";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('webadmin/post/export', {
        ...this.queryParams
