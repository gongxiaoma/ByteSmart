...
import com.bytesmart.webadmin.mapper.BytesmartConfigMapper;
 ...
 */
@Service
public class BytesmartConfigServiceImpl implements IBytesmartConfigService
{
    @Autowired
    private BytesmartConfigMapper configMapper;
    ...
    {
        BytesmartConfig config = new BytesmartConfig();
    ...
    public String selectConfigByKey(String configKey)
    {
        ...
        BytesmartConfig retConfig = configMapper.selectConfig(config);
    ...
    {
        BytesmartConfig temp = configMapper.selectConfigById(config.getConfigId());
    ...
    public void deleteConfigByIds(Long[] configIds)
    {
        ...
        {
            BytesmartConfig config = selectConfigById(configId);
    ...
    {
        List<BytesmartConfig> configsList = configMapper.selectConfigList(new BytesmartConfig());
        for (BytesmartConfig config : configsList)
        {
            redisService.setCacheObject(getCacheKey(config.getConfigKey()), config.getConfigValue());
        }
    }
    ...
    public boolean checkConfigKeyUnique(BytesmartConfig config)
    {
        ...
        BytesmartConfig info = configMapper.checkConfigKeyUnique(config.getConfigKey());
